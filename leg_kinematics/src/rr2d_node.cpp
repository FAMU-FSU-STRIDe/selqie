...
class RevoluteRevolute2DModel : public LegKinematicsModel
{
private:
    const float _L1 = 0.0;
    const float _L2 = 0.0;
...
public:
    RevoluteRevolute2DModel(const float L1, const float L2, const float y_axis)
...
class RevoluteRevolute2DNode : public rclcpp::Node
{
private:
...
public:
    RevoluteRevolute2DNode() : Node("rr2d_node")
    {
        float L1 = 0.066;
        ...
        _model = std::make_unique<RevoluteRevolute2DModel>(L1, L2, YA);
...
int main(int argc, char *argv[])
{
    ...
    rclcpp::spin(std::make_shared<RevoluteRevolute2DNode>());
    rclcpp::shutdown();
    return 0;
}
